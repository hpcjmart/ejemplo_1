 ...
 * ```
 */
export declare class VolumeTypeV3 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeTypeV3State, opts?: pulumi.CustomResourceOptions): VolumeTypeV3;
    /**
     * Returns true if the given object is an instance of VolumeTypeV3.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VolumeTypeV3;
    /**
