...
export declare class ImageAccessAccept extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImageAccessAcceptState, opts?: pulumi.CustomResourceOptions): ImageAccessAccept;
    /**
     * Returns true if the given object is an instance of ImageAccessAccept.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ImageAccessAccept;
    /**
