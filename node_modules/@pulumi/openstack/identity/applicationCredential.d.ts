 ...
 * ```
 */
export declare class ApplicationCredential extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApplicationCredentialState, opts?: pulumi.CustomResourceOptions): ApplicationCredential;
    /**
     * Returns true if the given object is an instance of ApplicationCredential.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApplicationCredential;
    /**
     * A collection of one or more access rules, which
     * this application credential allows to follow. The structure is described
     * below. Changing this creates a new application credential.
     */
    readonly accessRules: pulumi.Output<outputs.identity.ApplicationCredentialAccessRule[] | undefined>;
    /**
     ...
     */
    readonly unrestricted: pulumi.Output<boolean | undefined>;
    /**
