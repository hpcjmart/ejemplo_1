 ...
 * ```
 */
export declare class QosMinimumBandwidthRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QosMinimumBandwidthRuleState, opts?: pulumi.CustomResourceOptions): QosMinimumBandwidthRule;
    /**
     * Returns true if the given object is an instance of QosMinimumBandwidthRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is QosMinimumBandwidthRule;
    /**
     ...
     */
    readonly minKbps: pulumi.Output<number>;
    /**
